...
const NAVIGATION_ITEMS: TNavigationItem[] = [
  ...
  { id: "4.5", path: urls.client.displaylog, name: "Dziennik", element: <DziennikLog />, isMenu: true, minUserRole: EUserRole.ADMIN },
  { id: "4.6", path: urls.client.system, name: "System", element: <SystemSettings/>, isMenu: true, minUserRole: EUserRole.ADMIN},
