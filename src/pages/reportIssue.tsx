export const ReportIssueScreen = (props:any) => {
    return(
        ...
        <div style={{backgroundColor: '', width: '35%'}} className="divider text-justify"><h3 style={{textAlign: "center"}}>Instrukcja</h3>
        ...
        <div style={{backgroundColor: '', width: '65%'}}className="content-padding text-justify"><h3 style={{textAlign: "center"}}>Zgłoś usterkę</h3>miejsce usterki: [placeholder]<br></br>opis usterki <input type="text"></input><br></br>kategoria zgłoszenia:</div>        
